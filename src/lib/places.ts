...
export const PLACES: Place[] = [
  ...
  },
  {
    ...
    emoji: "🏢",
    blurb: "India's largest convention & expo centre — vast halls, shows and events.",
    lat: 28.5459,
    lng: 77.0721,
    station: "Dwarka Sector - 21",
    lineKeys: ["blue", "airport"],
    restaurants: [
      { name: "Sagar Ratna (Dwarka)", knownFor: "South-Indian thalis & dosas" },
      { name: "Barbeque Nation (Dwarka)", knownFor: "Live-grill buffet" },
    ],
  },
  {
    key: "bharat-mandapam",
    ...
    emoji: "🏛️",
    blurb: "Revamped convention complex that hosted the G20 — exhibitions year-round.",
    lat: 28.6176,
    lng: 77.2437,
    station: "Supreme Court",
    lineKeys: ["blue"],
    restaurants: [
      { name: "Gulati (Pandara Road)", knownFor: "Butter chicken & Mughlai classics" },
      { name: "Pindi (Pandara Road)", knownFor: "Old-school Punjabi since 1948" },
    ],
  },
  {
    key: "delhi-zoo",
    ...
    emoji: "🦁",
    blurb: "Delhi's 176-acre zoo beside Purana Qila — tigers, big cats and a lake.",
    lat: 28.6096,
    lng: 77.2464,
    station: "Supreme Court",
    lineKeys: ["blue"],
    restaurants: [
      { name: "Sunder Nagar Sweet House", knownFor: "Chaat & Bengali sweets" },
      { name: "Triveni Terrace Cafe (Mandi House)", knownFor: "Leafy courtyard café" },
    ],
  },
  {
    key: "waste-to-wonder",
    ...
    emoji: "🗿",
    blurb: "Seven Wonders of the World rebuilt from scrap metal — best lit up at night.",
    lat: 28.584,
    lng: 77.2588,
    station: "Sarai Kale Khan - Nizamuddin",
    lineKeys: ["pink"],
    restaurants: [
      { name: "Karim's (Nizamuddin)", knownFor: "Mughlai kebabs & korma" },
      { name: "Ghalib Kabab Corner", knownFor: "Late-night seekh & rolls" },
    ],
  },
  {
    key: "sunder-nursery",
    name: "Sunder Nursery",
    emoji: "🌷",
    blurb: "16th-century heritage garden with Mughal tombs, lakes and rose beds.",
    lat: 28.5972,
    lng: 77.247,
    station: "Sarai Kale Khan - Nizamuddin",
    lineKeys: ["pink"],
    restaurants: [
      { name: "Karim's (Nizamuddin)", knownFor: "The Mughlai institution" },
      { name: "Dastarkhwan-e-Karim", knownFor: "Nihari & sheermal" },
    ],
  },
  {
    key: "nizamuddin-dargah",
    name: "Hazrat Nizamuddin Dargah",
    emoji: "🕌",
    blurb: "Sufi shrine famous for Thursday-evening qawwali in a lantern-lit lane.",
    lat: 28.5912,
    lng: 77.243,
    station: "Jangpura",
    lineKeys: ["violet"],
    restaurants: [
      { name: "Ghalib Kabab Corner", knownFor: "Seekh kebabs by the dargah" },
      { name: "Dastarkhwan-e-Karim", knownFor: "Mutton korma & biryani" },
    ],
  },
  {
    key: "jhandewalan-hanuman",
    name: "Jhandewalan Hanuman Mandir",
    emoji: "🐒",
    blurb: "The 108-ft Hanuman statue looming over the Metro — visible for miles.",
    lat: 28.6449,
    lng: 77.1975,
    station: "Jhandewalan",
    lineKeys: ["blue"],
    restaurants: [
      { name: "Roshan Di Kulfi (Karol Bagh)", knownFor: "Kulfi-falooda & chole bhature" },
      { name: "Bille Di Hatti (Karol Bagh)", knownFor: "Butter-loaded Punjabi thalis" },
    ],
  },
  {
    key: "birla-mandir",
    name: "Birla Mandir (Laxminarayan)",
    emoji: "🛕",
    blurb: "1930s marble temple inaugurated by Gandhi — gardens and painted spires.",
    lat: 28.6329,
    lng: 77.1965,
    station: "RK Ashram Marg",
    lineKeys: ["blue"],
    restaurants: [
      { name: "Bengali Sweet House (Gole Market)", knownFor: "Chaat, sweets & South Indian" },
      { name: "Kake Da Hotel (CP)", knownFor: "Rich Punjabi curries" },
    ],
  },
  {
    key: "agrasen-baoli",
    ...
    emoji: "🪜",
    blurb: "A hauntingly geometric 60-step stepwell hidden off Connaught Place.",
    lat: 28.6255,
    lng: 77.2245,
    station: "Barakhamba",
    lineKeys: ["blue"],
    restaurants: [
      { name: "United Coffee House (CP)", knownFor: "Colonial-era café classics" },
      { name: "Wenger's (CP)", knownFor: "Bakery & patties since 1926" },
    ],
  },
  {
    key: "national-museum",
    ...
    emoji: "🏺",
    blurb: "India's biggest museum — Harappan relics, miniatures and the Buddha's remains.",
    lat: 28.6117,
    lng: 77.2192,
    ...
    restaurants: [
      { name: "Andhra Bhavan Canteen", knownFor: "Legendary unlimited thali" },
      { name: "Saravana Bhavan (Janpath)", knownFor: "South-Indian tiffin" },
    ],
  },
  {
    key: "rashtrapati-bhavan",
    name: "Rashtrapati Bhavan & Amrit Udyan",
    emoji: "🏰",
    blurb: "The President's palace and its Mughal-style gardens, open in spring.",
    lat: 28.6143,
    lng: 77.1994,
    station: "Central Secretariat",
    lineKeys: ["yellow", "violet"],
    restaurants: [
      { name: "The Imperial (Janpath)", knownFor: "Colonial high tea" },
      { name: "Andhra Bhavan Canteen", knownFor: "Fiery Andhra thali" },
    ],
  },
  {
    key: "majnu-ka-tila",
    name: "Majnu ka Tila",
    emoji: "🏔️",
    blurb: "Little Tibet by the Yamuna — momos, monasteries and mountain cafés.",
    lat: 28.706,
    lng: 77.228,
    station: "Vidhan Sabha",
    lineKeys: ["yellow"],
    restaurants: [
      { name: "Ama Cafe", knownFor: "Tibetan breakfasts & coffee" },
      { name: "Rigo Restaurant", knownFor: "Thukpa & steamed momos" },
    ],
  },
];
